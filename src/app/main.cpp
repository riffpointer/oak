...
int main(int argc, char *argv[])
{
	...
	olive::App::AppParams startup_params;
	...
	if (export_option->IsSet()) {
		startup_params.set_run_mode(olive::App::AppParams::kHeadlessExport);
	}
	...
	if (startup_params.run_mode() == olive::App::AppParams::kRunNormal) {
#ifdef _WIN32
