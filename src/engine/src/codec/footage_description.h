/***  Oak Video Editor - Footage Description (engine-local copy)  Copyright (C) 2025 mikesolar  ***/

#ifndef FOOTAGE_DESCRIPTION_H
#define FOOTAGE_DESCRIPTION_H
